                    ...
                    <div class="product-sidebar">
                        ...
                        <div class="single-widget search">
                            ...
                            <form action="{{route('search')}}" method="get">
                                <input type="search"  name="searchproduct"  id="search_product" placeholder="Search Here..." required>
                                            ...
                                            <div class="single-product">
                                                ...
                                                <div class="product-info">
                                                    ...
                                                    <div class="title" style=" display: -webkit-box;-webkit-line-clamp:2;-webkit-box-orient: vertical; overflow: hidden; height:45px;">
                                                        <a href="{{route('product-detail',['product_id'=>$product->id])}}" title="{{$product->name}}">{{$product->name}} </a>
                                                    ...
                                                    <div class="col-lg-4 col-md-4 col-12">
                                                        <div class="product-image">
                                                            <img src="{{asset($product->image)}}" alt="" height="180"
                                                                 width="150">
                                                            <div class="button">
                                                                <a href="{{route('product-detail',['product_id'=>$product->id])}}" class="btn"><i
