            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 col-md-6 col-12">
                    <ul class="breadcrumb-nav">
                        ...
                        <li><a href="{{route('product-category',['category_id'=>$subcategory->category->id])}}">{{$subcategory->category->name}}</a></li>
                    ...
                    <div class="product-sidebar">
                        ...
                        <div class="single-widget search">
                            ...
                            <form action="{{route('search')}}" method="get">
                                <input type="search" id="search_product" required name="searchproduct" placeholder="Search Here..." required>
                        ...
                        <div class="single-widget">
                            ...
                            @foreach($categories as $category)
                                ...
                                <ul class="list">
                                    ...
                                    <li>
                                        <a href="{{route('product-category',['category_id'=>$category->id])}}">{{$category->name}}
                                            <small>({{$catProductCount}})</small></a>
                                ...
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="flexCheckDefault11">
                                        <ul class="list">
                                            ...
                                            <li>
                                                <a href="{{route('product-brand',['brand_id'=>$brand->id])}}">{{$brand->name}}
                                                    <small> ({{$brandProductCount}})</small></a>
                        ...
                        <div class="tab-content" id="nav-tabContent">
                            <div class="tab-pane fade show active" id="nav-grid" role="tabpanel"
                                ...
                                <div class="row">
                                        ...
                                        <div class="col-lg-4 col-md-6 col-12">
                                            ...
                                            <div class="single-product">
                                                ...
                                                <div class="product-info">
                                                    <span class="category"> {{$product->subcategory->name}} | {{$product->brand->name}}</span>
                                                    ...
                                                    <div class="price">
                                                        ...
                                                        @if($product->regular_price!=null)
                                                                <del style="color:#808080; font-size: 18px; font-family:bold" >&#2547; {{$product->regular_price}}</del>
                                                         @endif
                                                    </div>
                                    ...
                                    @endforeach
                                    @else
                                        <p class="text-center pt-5"> Sorry! no product here</p>
                                    @endif
                                </div>
                                <div class="row ">
                                            ...
                                            <div class="single-product">
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-lg-8 col-md-8 col-12">
                                                        <div class="product-info">
                                                            <span
                                                                class="category"> {{$product->subcategory->name}} | {{$product->brand->name}}</span>
                                                            <h4 class="title">
                                                                <a href="{{route('product-detail',['product_id'=>$product->id])}}">{{$product->name}}</a>
                                                            </h4>
