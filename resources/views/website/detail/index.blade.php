                    ...
                    <div class="product-info">
                        ...
                        <div class="bottom-content">
                            <div class="row align-items-end">
                                <div class="col-lg-4 col-md-4 col-12">
                                    <div class="button">
{{--                                        <button onclick="location.href='{{route('shop-cart')}}'" class="btn btn-primary " style="width: 100%;">  Add to Cart </button>--}}
                                        <a href="{{route('shop-cart')}}" class="btn btn-primary " style="width: 100%;">Add to Cart</a>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-4 col-12">
