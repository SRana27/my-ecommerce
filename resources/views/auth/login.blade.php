                ...
                <form class="form-horizontal form-material" action="{{route('login')}}" method="post">
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12 m-t-10 text-center">
                            <div class="social">
                                <button class="btn btn-facebook" data-bs-toggle="tooltip" title="Login with Facebook"> <i aria-hidden="true" class=" ti-facebook"></i> </button>
                                <button class="btn btn-googleplus" data-bs-toggle="tooltip" title="Login with Google"> <i aria-hidden="true" class=" ti-google"></i> </button>
                            </div>
                        </div>
                    </div>
