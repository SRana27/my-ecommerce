                    ...
                    <form class="form-horizontal p-t-20" method="post" action="{{route('new.product')}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                ...
                                <select name="subcategory_id" class="form-control"  id="subCategoryId" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                ...
                                <select name="brand_id" class="form-control" required id="exampleInputuname2">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                ...
                                <select name="unit_id" class="form-control" required id="exampleInputuname2">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="ProductCode" name="code" required placeholder="product code">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="exampleInputuname3" class="col-sm-3 control-label">Product Model <span class="text-danger">*</span></label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="exampleInputuname3" name="model" required placeholder="product model">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="ProductAmount" class="col-sm-3 control-label">Product Stock Amount <span class="text-danger">*</span></label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="ProductAmount" name="stock_amount" required placeholder=" stock amount">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control" id="exampleInputEmail3" name="short_description" required placeholder="Product Short Description" cols="10" rows="5"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="file" id="input-file-now"  required class="dropify" name="image" accept="image/*"/>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="form-label col-sm-3 control-label" for="web">Other Image</label>
                            <div class="col-sm-9">
                                <input type="file" id="input-file-now"  class="dropify" required name="other_image[]" multiple  accept="image/*"/>
                            </div>
                        </div>
