        ...
        <ul id="sidebarnav">
            ...
            <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="ti-layout-grid2"></i>
                ...
                <ul aria-expanded="false" class="collapse">
                    ...
                    <li><a href="app-email-detail.html">Manage Customer</a></li>
            ...
            <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="ti-layout-grid2"></i>
                ...
                <ul aria-expanded="false" class="collapse">
                    <li><a href="app-email.html">Add User</a></li>
                    <li><a href="app-email-detail.html">Manage User</a></li>
            ...
            <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="ti-layout-grid2"></i>
                ...
                <ul aria-expanded="false" class="collapse">
                    <li><a href="app-email.html">Add Coupon</a></li>
                    <li><a href="app-email-detail.html">Manage Coupon</a></li>
            ...
            <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="ti-settings"></i>
                ...
                <ul aria-expanded="false" class="collapse">
                    <li><a href="app-email-detail.html">Company Setting</a></li>
                    <li><a href="app-email-detail.html">Tax Setting</a></li>
                    <li><a href="app-email-detail.html">Shipping Setting</a></li>
                </ul>
            </li>
        </ul>
    </nav>
